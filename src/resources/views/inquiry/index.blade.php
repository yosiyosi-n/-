        ...
        <form action="{{ route('inquiry.confirm') }}" method="POST" class="inquiry-form">
            ...
            <div class="form-group">
                ...
                <div class="form-input-area">
                    <div class="form-flex">
                        <input type="text" name="first_name" id="first-name" value="{{ old('first_name') }}" placeholder="姓" class="form-flex-item">
                        <input type="text" name="last_name" id="last-name" value="{{ old('last_name') }}" placeholder="名" class="form-flex-item">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-area">
                    <div class="form-tel-group">
                        <input type="text" name="telephone_one" id="telephone-one" value="{{ old('telephone_one') }}" class="form-tel-input">
                        <span>-</span>
                        <input type="text" name="telephone_two" id="telephone-two" value="{{ old('telephone_two') }}" class="form-tel-input">
                        <span>-</span>
                        <input type="text" name="telephone_three" id="telephone-three" value="{{ old('telephone_three') }}" class="form-tel-input">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="form-input-area">
                    <input type="text" name="building_name" id="building-name" value="{{ old('building_name') }}">
                </div>
            </div>
            ...
            <div class="form-btn-row">
                <button type="submit" class="btn btn-submit">確認画面</button>
            </div>
        </form>
    </div>
@endsection
